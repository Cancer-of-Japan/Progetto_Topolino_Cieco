...
void AdjustToLeft() {
  ...
  analogWrite(leftpin1, 0);
  analogWrite(leftpin2, 165);
}

void AdjustToRight() {
  analogWrite(rightpin1, 0);
  analogWrite(rightpin2, 165);
  analogWrite(leftpin1, 0);
  analogWrite(leftpin2, 180);
}

void TiltToLeft() {
  analogWrite(rightpin1, 0);
  analogWrite(rightpin2, 80);
  analogWrite(leftpin1, 80);
  analogWrite(leftpin2, 0);
}

void TiltToRight() {
  analogWrite(rightpin1, 80);
  analogWrite(rightpin2, 0);
  analogWrite(leftpin1, 0);
...
void TurnRightPrecisly() {
  ...
  if (rresult_left_func > 1.1 * 10) {
    var = 2;
  }
  if (result_left_func > 9.5 && result_left_func < 10.5) {
    var = 3;
  }
  switch (var) {
    case 1:
...
void TurnLeftPrecisly() {
  ...
  if (result_right_func > 9.5 && result_right_func < 10.5) {
    var = 3;
  }
