...
void AdjustToLeft() {
  ...
  analogWrite(leftpin1, 0);
  analogWrite(leftpin2, 90);
}

void AdjustToRight() {
  analogWrite(rightpin1, 0);
  analogWrite(rightpin2, 90);
  analogWrite(leftpin1, 0);
...
void GoForward_Adujust() {
  ...
  if (result_right_func < 6 && result_left_func > 19) {
    var = 5;
  }
  if (result_right_func > 19 && result_left_func < 6) {
    var = 6;
  }
  // if (result_right_func > 12) {
  //   var = 6;
  // }
  // if (result_left_func > 12) {
  //   var = 6;
  // }
